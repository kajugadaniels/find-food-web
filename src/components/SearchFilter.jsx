                            ...
                            <div className="wd-search-form ">
                                ...
                                <div className="group-price">
                                    <div className="slider-item">
                                        <div className="slider-label">Price Range: <span id="price-output">$200 - $2,500,000</span></div>
                                        <div className="slider price-slider">
                                            <input type="range" id="price-range-min" className="range-min" min="200" max="2500000" value="200" step="100" />
                                            <input type="range" id="price-range-max" className="range-max" min="200" max="2500000" value="2500000" step="100" />
                                            <div className="slider-fill"></div>
                                        </div>
                                    </div>

                                    <div className="slider-item">
                                        <div className="slider-label">Size Range: <span id="size-output">146 SqFt - 448 SqFt</span></div>
                                        <div className="slider size-slider">
                                            <input type="range" id="size-range-min" className="range-min" min="146" max="448" value="146" step="1" />
                                            <input type="range" id="size-range-max" className="range-max" min="146" max="448" value="448" step="1" />
                                            <div className="slider-fill"></div>
                                        </div>
                                    </div>
                                </div>
